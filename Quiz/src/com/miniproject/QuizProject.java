...
public class QuizProject extends JPanel{
    ...
    public QuizProject() {
        ...
        Font titeS = new Font("DungGeunMo", Font.PLAIN, 20);
        Font titeM = new Font("DungGeunMo", Font.ITALIC, 48);
        Font name = new Font("DungGeunMo", Font.PLAIN, 20); 
        Color text = new Color(0x000000);
        Color titMG = new Color(0x000000);
